...
import kotlinx.android.synthetic.main.fragment_rc_personal.*
 ...
 * Use the [RcPersonalFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RcPersonalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rc_personal, container, false)
    }
...
//            Log.d("Rc1Fragment", "${member.jenisKelamin}")
    ...
    companion object {
         ...
         * @return A new instance of fragment RcPersonalFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RcPersonalFragment().apply {
