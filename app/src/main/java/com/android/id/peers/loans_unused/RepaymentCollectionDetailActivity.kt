...
import com.android.id.peers.loans_unused.adapters.RcdTablePagerAdapter
...
class RepaymentCollectionDetailActivity : AppCompatActivity() {
    ...
    private var collection = com.android.id.peers.loans_unused.models.Collection()
...
//                this, ApiConnections.REQUEST_TYPE_GET_MEMBER, object : MemberCallback {
